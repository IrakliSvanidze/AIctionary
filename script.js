const terms = [
  ...
  { term: 'Foundation Model', category: 'Generative AI', level: 'Intermediate', definition: 'დიდ მონაცემებზე წინასწარ გაწვრთნილი ფართო დანიშნულების მოდელი.', learnMore: 'Foundation model შემდეგ შეიძლება მრავალ სხვადასხვა ამოცანაზე ადაპტირდეს.' },
  { term: 'World Model', category: 'Generative AI', level: 'Advanced', definition: 'მოდელი, რომელიც გარემოს დინამიკას შიდა წარმოდგენაში სწავლობს.', learnMore: 'იგი აგენტს პროგნოზირებასა და დაგეგმვაში ეხმარება.' },
  { term: 'Latent Diffusion', category: 'Generative AI', level: 'Advanced', definition: 'diffusion მოდელი, რომელიც კომპრესირებულ latent სივრცეში მუშაობს.', learnMore: 'ეს ამცირებს გამოთვლით ღირებულებას და აჩქარებს გენერაციას.' },
  { term: 'Token Healing', category: 'Generative AI', level: 'Advanced', definition: 'ტოკენიზაციის კიდეებზე გენერაციის შეცდომების შემცირების ტექნიკა.', learnMore: 'იგი აუმჯობესებს გაგრძელების სტაბილურობას ტექსტის ფრაგმენტების ირგვლივ.' },
  { term: 'Context Compression', category: 'Generative AI', level: 'Advanced', definition: 'გრძელი კონტექსტის შეკუმშვა მნიშვნელობის დაკარგვის მინიმიზაციით.', learnMore: 'გამოიყენება მაშინ, როცა context window შეზღუდულია.' },
  { term: 'Semantic Cache', category: 'Generative AI', level: 'Intermediate', definition: 'ქეში, რომელიც მნიშვნელობით მსგავს მოთხოვნებს თავიდან იყენებს.', learnMore: 'ეს ამცირებს ფასსა და latency-ს.' },
  { term: 'Grounded Answer', category: 'Generative AI', level: 'Beginner', definition: 'პასუხი, რომელიც წყაროებით ან მტკიცებულებით არის გამყარებული.', learnMore: 'grounded პასუხი ნაკლებად მიდრეკილია ჰალუცინაციისკენ.' },
  { term: 'Tool Router', category: 'Generative AI', level: 'Advanced', definition: 'კომპონენტი, რომელიც წყვეტს რომელი ინსტრუმენტი უნდა გამოიძახოს სისტემამ.', learnMore: 'ეს განსაკუთრებით მნიშვნელოვანია მრავალ-ინსტრუმენტიან აგენტებში.' },
  { term: 'Agent Loop', category: 'Generative AI', level: 'Intermediate', definition: 'აგენტის განმეორებადი ციკლი: იფიქრე, იმოქმედე, შეაფასე.', learnMore: 'loop ამოცანის ეტაპობრივ შესრულებას უზრუნველყოფს.' },
  { term: 'Reflection', category: 'Generative AI', level: 'Intermediate', definition: 'მოდელის მიერ საკუთარი პასუხის გადახედვა და გაუმჯობესება.', learnMore: 'reflection ბევრ აგენტურ workflow-ში ხარისხს ზრდის.' },
  { term: 'Self-Critique', category: 'Generative AI', level: 'Advanced', definition: 'მოდელის უნარი საკუთარი შედეგის სისუსტეების გამოვლენისათვის.', learnMore: 'იგი refinement-ის დამატებითი ნაბიჯია.' },
  { term: 'Verifier-Guided Search', category: 'Generative AI', level: 'Advanced', definition: 'ძიება, სადაც verifier პასუხის სისწორეს აფასებს.', learnMore: 'ამ გზით რთულ ამოცანებზე უკეთესი ვარიანტები შეიძლება მოიძებნოს.' },
  { term: 'Monte Carlo Tree Search', category: 'Machine Learning', level: 'Advanced', definition: 'ძიების სტრატეგია, რომელიც შემთხვევით სიმულაციებსა და ხის გაფართოებას იყენებს.', learnMore: 'იგი თამაშებსა და დაგეგმვის ამოცანებში გამოიყენება.' },
  { term: 'Search Policy', category: 'Machine Learning', level: 'Advanced', definition: 'წესი, რომელიც განსაზღვრავს რომელი მოქმედება უნდა გამოიკვლიოს აგენტმა.', learnMore: 'საძიებო პოლიტიკა დაგეგმვის ხარისხზე დიდ გავლენას ახდენს.' },
  { term: 'Value Function', category: 'Machine Learning', level: 'Advanced', definition: 'ფუნქცია, რომელიც მდგომარეობის ან ქმედების მოსალოდნელ სარგებელს აფასებს.', learnMore: 'RL-ში ის უკეთესი გადაწყვეტილებების მისაღებად გამოიყენება.' },
  { term: 'Policy Network', category: 'Machine Learning', level: 'Advanced', definition: 'ქსელი, რომელიც მდგომარეობიდან ქმედებაზე განაწილებას პროგნოზირებს.', learnMore: 'policy network actor ნაწილად ხშირად გვხვდება.' },
  { term: 'Replay Buffer', category: 'Machine Learning', level: 'Advanced', definition: 'RL-ში დაგროვილი გამოცდილების საცავი.', learnMore: 'იგი ნიმუშების ხელახალ გამოყენებას და სტაბილურ სწავლებას უწყობს ხელს.' },
  { term: 'Temporal Difference Learning', category: 'Machine Learning', level: 'Advanced', definition: 'სწავლება პროგნოზისა და მომდევნო შეფასების სხვაობით.', learnMore: 'TD learning RL-ის მრავალი ალგორითმის საფუძველია.' },
  { term: 'Off-Policy Learning', category: 'Machine Learning', level: 'Advanced', definition: 'სწავლება იმ ქცევისგან განსხვავებული პოლიტიკის ოპტიმიზაციისთვის.', learnMore: 'Q-learning off-policy მიდგომის ცნობილი მაგალითია.' },
  { term: 'On-Policy Learning', category: 'Machine Learning', level: 'Advanced', definition: 'სწავლება იმავე პოლიტიკიდან მიღებული გამოცდილებით, რომელსაც აუმჯობესებ.', learnMore: 'SARSA on-policy RL ალგორითმია.' },
  { term: 'SARSA', category: 'Machine Learning', level: 'Advanced', definition: 'on-policy RL ალგორითმი state-action-reward-state-action განახლებებით.', learnMore: 'იგი პოლიტიკის მიმდინარე ქცევას მიჰყვება.' },
  { term: 'Exploration Strategy', category: 'Machine Learning', level: 'Advanced', definition: 'წესი, როგორ გამოცადოს აგენტმა ახალი ქმედებები.', learnMore: 'exploration-exploitation ბალანსი RL-ის ცენტრალური თემაა.' },
  { term: 'Epsilon-Greedy', category: 'Machine Learning', level: 'Intermediate', definition: 'სტრატეგია, სადაც აგენტი ხანდახან შემთხვევით არჩევს მოქმედებას.', learnMore: 'იგი მარტივი exploration მექანიზმია.' },
  { term: 'Bandit Problem', category: 'Machine Learning', level: 'Intermediate', definition: 'არჩევანის ამოცანა, სადაც უნდა დაბალანსდეს ცდა და სარგებლის მოპოვება.', learnMore: 'bandit-ები რეკომენდაციებსა და რეკლამაში გამოიყენება.' },
  { term: 'Reward Shaping', category: 'Machine Learning', level: 'Advanced', definition: 'reward-ის დამატებითი სიგნალებით გამდიდრება სასურველი ქცევის დასაჩქარებლად.', learnMore: 'არასწორმა shaping-მა შეიძლება მავნე shortcut-ები გამოიწვიოს.' },
  { term: 'Hierarchical RL', category: 'Machine Learning', level: 'Advanced', definition: 'RL, სადაც აგენტი მაღალი და დაბალი დონის ქვეპოლიტიკებად იყოფა.', learnMore: 'ეს რთულ ამოცანებს ქვეამოცანებად შლის.' },
  { term: 'Offline RL', category: 'Machine Learning', level: 'Advanced', definition: 'RL ფიქსირებულ ისტორიულ მონაცემებზე ახალი ინტერაქციის გარეშე.', learnMore: 'უსაფრთხო გარემოებში ეს მიდგომა პრაქტიკულია.' },
  { term: 'Preference Learning', category: 'Generative AI', level: 'Advanced', definition: 'მოდელის სწავლება ადამიანური უპირატესობების მიხედვით.', learnMore: 'იგი alignment-ის მრავალ მეთოდში გამოიყენება.' },
  { term: 'Judge Benchmark', category: 'Generative AI', level: 'Intermediate', definition: 'ტესტები, სადაც მოდელი სხვა პასუხებს აფასებს როგორც მოსამართლე.', learnMore: 'ასეთი ბენჩმარკები meta-evaluation-ს ეხმარება.' },
  { term: 'Toolformer Prompt', category: 'Generative AI', level: 'Advanced', definition: 'პრომპტის სტილი, რომელიც ხელსაწყოს გამოყენების ნიშნებს შეიცავს.', learnMore: 'ეს მოდელს ეხმარება გაიგოს როდის სჭირდება tool call.' },
  { term: 'RAG Chunk Overlap', category: 'Generative AI', level: 'Intermediate', definition: 'მეზობელ დოკუმენტურ ნაწილებს შორის საერთო ტექსტის რაოდენობა.', learnMore: 'overlap კონტექსტის დაკარგვას ამცირებს, მაგრამ დუბლირებას ზრდის.' },
  { term: 'Prompt Delimiter', category: 'Generative AI', level: 'Beginner', definition: 'სიმბოლო ან ნიშანი, რომელიც prompt-ის ნაწილებს აშორებს.', learnMore: 'delimiter-ები სტრუქტურას და parsing-ს აუმჯობესებს.' },
  { term: 'Context Injection', category: 'Generative AI', level: 'Intermediate', definition: 'გარე ინფორმაციის prompt-ში დამატება პასუხის გასაუმჯობესებლად.', learnMore: 'RAG სისტემები სწორედ context injection-ს იყენებს.' },
  { term: 'Semantic Router', category: 'Generative AI', level: 'Advanced', definition: 'კომპონენტი, რომელიც მოთხოვნას მნიშვნელობის მიხედვით შესაბამის გზაზე აგზავნის.', learnMore: 'იგი model routing-სა და tool routing-ში გამოიყენება.' },
  { term: 'Model Router', category: 'Generative AI', level: 'Intermediate', definition: 'სისტემა, რომელიც მოთხოვნას შესაბამის მოდელზე გადაანაწილებს.', learnMore: 'routing შეიძლება ფასის, ხარისხის ან latency-ის მიხედვით ხდებოდეს.' },
  { term: 'Cascade Model', category: 'Generative AI', level: 'Advanced', definition: 'რამდენიმე მოდელის ჯაჭვური გამოყენება მარტივიდან რთულამდე.', learnMore: 'კასკადი cost-quality ბალანსს ხშირად აუმჯობესებს.' },
  { term: 'Distilled Model', category: 'Machine Learning', level: 'Intermediate', definition: 'პატარა მოდელი, რომელმაც ცოდნა teacher-ისგან მიიღო.', learnMore: 'იგი სწრაფია და deployment-ისთვის ხშირად უკეთესია.' },
  { term: 'Quantized Model', category: 'Machine Learning', level: 'Intermediate', definition: 'მოდელი, რომლის წონები დაბალი სიზუსტის ფორმატშია შენახული.', learnMore: 'ასეთი მოდელი ნაკლებ მეხსიერებას მოითხოვს.' },
  { term: 'Pruned Model', category: 'Machine Learning', level: 'Intermediate', definition: 'მოდელი, სადაც ნაკლებად მნიშვნელოვანი წონები მოცილებულია.', learnMore: 'pruning ეფექტიანობას ზრდის.' },
  { term: 'Serving Endpoint', category: 'Machine Learning', level: 'Beginner', definition: 'ქსელური მისამართი, საიდანაც მოდელის გამოყენება შეიძლება.', learnMore: 'endpoint ხშირად REST ან gRPC ინტერფეისია.' },
  { term: 'Inference Server', category: 'Machine Learning', level: 'Intermediate', definition: 'სერვისი, რომელიც მოდელის prediction-ებს აწვდის მომხმარებელს.', learnMore: 'იგი throughput-სა და latency-ს მართავს.' },
  { term: 'Autosuggest', category: 'NLP', level: 'Beginner', definition: 'მომხმარებლის წერილისას შემდეგი სიტყვების ან ფრაზების შეთავაზება.', learnMore: 'ასეთი ფუნქცია ეყრდნობა ენობრივ მოდელებს და ქცევით სიგნალებს.' },
  { term: 'Spell Correction', category: 'NLP', level: 'Beginner', definition: 'ტექსტში მართლწერის შეცდომების პოვნა და გამოსწორება.', learnMore: 'იგი კლასიკურ NLP-საც და თანამედროვე LLM-ებსაც შეუძლია.' },
  { term: 'Grammar Correction', category: 'NLP', level: 'Intermediate', definition: 'წინადადების გრამატიკული შეცდომების გამოსწორება.', learnMore: 'ეს ამოცანა გენერაციულ ტექსტურ მოდელებში ფართოდ გამოიყენება.' },
  { term: 'Paraphrasing', category: 'NLP', level: 'Intermediate', definition: 'იმავე აზრის სხვა ფორმულირებით გადმოცემა.', learnMore: 'პარაფრაზი შეჯამებასა და წერის ხელსაწყოებში ხშირად გვხვდება.' },
  { term: 'Natural Language Inference (NLI)', category: 'NLP', level: 'Advanced', definition: 'ამოცანა, რომელიც ადგენს მოსდევს, ეწინააღმდეგება თუ ნეიტრალურია ტექსტები ერთმანეთის მიმართ.', learnMore: 'NLI ტექსტური reasoning-ის კლასიკური benchmark-ია.' },
  { term: 'Entity Linking', category: 'NLP', level: 'Advanced', definition: 'ტექსტში მოხსენიებული ერთეულის დაკავშირება კონკრეტულ ცოდნის ბაზის ობიექტთან.', learnMore: 'იგი NER-ზე ერთი ნაბიჯით შორს მიდის.' },
  { term: 'Relation Extraction', category: 'NLP', level: 'Advanced', definition: 'ტექსტიდან ობიექტებს შორის კავშირების ამოღება.', learnMore: 'ეს knowledge graph-ის შევსებაში გამოიყენება.' },
  { term: 'Text Normalization', category: 'NLP', level: 'Beginner', definition: 'ტექსტის სტანდარტულ ფორმატში მოყვანა დამუშავებამდე.', learnMore: 'მაგალითებია lowercase, რიცხვების გარდაქმნა და სიმბოლოების გაწმენდა.' },
  { term: 'Document Parsing', category: 'NLP', level: 'Intermediate', definition: 'დოკუმენტის სტრუქტურის, ტექსტისა და ველების ამოღება.', learnMore: 'ხშირად გამოიყენება invoice-სა და კონტრაქტების ანალიზში.' },
  { term: 'Table Extraction', category: 'NLP', level: 'Intermediate', definition: 'დოკუმენტიდან ცხრილური ინფორმაციის გამოყოფა.', learnMore: 'OCR და layout analysis ამას ხშირად ერთად იყენებს.' },
  { term: 'Layout Analysis', category: 'Computer Vision', level: 'Intermediate', definition: 'დოკუმენტის ვიზუალური სტრუქტურის ამოცნობა.', learnMore: 'იგი header-ებს, პარაგრაფებს, ცხრილებს და ბლოკებს არჩევს.' },
  { term: 'Scene Understanding', category: 'Computer Vision', level: 'Advanced', definition: 'სურათში ობიექტების, მათი ურთიერთობებისა და კონტექსტის ერთიანი გაგება.', learnMore: 'ეს perception-ის უფრო მაღალი დონის ამოცანაა.' },
  { term: 'Action Recognition', category: 'Computer Vision', level: 'Intermediate', definition: 'ვიდეოში მოქმედების ან აქტივობის ამოცნობა.', learnMore: 'გამოიყენება სპორტში, უსაფრთხოებასა და ვიდეო ანალიტიკაში.' },
  { term: 'Video Classification', category: 'Computer Vision', level: 'Intermediate', definition: 'ვიდეოკლიპისთვის კატეგორიის მინიჭება.', learnMore: 'ამოცანა ითვალისწინებს როგორც კადრებს, ისე დროულ დინამიკას.' },
  { term: 'Video Segmentation', category: 'Computer Vision', level: 'Advanced', definition: 'ვიდეოში ობიექტების პიქსელური დონით გამოყოფა დროში.', learnMore: 'იგი უფრო რთულია ვიდრე ერთ კადრზე segmentation.' },
  { term: 'Multi-Object Tracking', category: 'Computer Vision', level: 'Advanced', definition: 'ვიდეოში რამდენიმე ობიექტის იდენტობის შენარჩუნება კადრებიდან კადრამდე.', learnMore: 'tracking იყენებს detection-სა და motion cues-ს.' },
  { term: 'Keypoint Detection', category: 'Computer Vision', level: 'Intermediate', definition: 'მნიშვნელოვანი წერტილების ლოკალიზაცია სურათზე.', learnMore: 'ეს pose estimation-ის საფუძველია.' },
  { term: 'Edge Detection', category: 'Computer Vision', level: 'Beginner', definition: 'სურათში საზღვრებისა და მკვეთრი ცვლილებების პოვნა.', learnMore: 'ეს ერთ-ერთი კლასიკური vision ოპერაციაა.' },
  { term: 'Feature Matching', category: 'Computer Vision', level: 'Intermediate', definition: 'საერთო ვიზუალური ნიშნების დაკავშირება სხვადასხვა სურათებს შორის.', learnMore: 'იგი stitching-სა და 3D reconstruction-ში გამოიყენება.' },
  { term: '3D Reconstruction', category: 'Computer Vision', level: 'Advanced', definition: '2D სურათებიდან სამგანზომილებიანი სტრუქტურის აღდგენა.', learnMore: 'იგი robotics-სა და AR-სთვის მნიშვნელოვანია.' },
  { term: 'Point Cloud', category: 'Computer Vision', level: 'Intermediate', definition: 'სამგანზომილებიანი წერტილების ნაკრები სივრცეში.', learnMore: 'LiDAR და depth sensor-ები point cloud-ს ქმნის.' },
  { term: 'LiDAR Perception', category: 'Computer Vision', level: 'Advanced', definition: 'LiDAR სენსორის მონაცემების დამუშავება გარემოს გასაგებად.', learnMore: 'ავტონომიური მანქანები მას ხშირად კამერებთან ერთად იყენებს.' },
  { term: 'Sensor Fusion', category: 'Computer Vision', level: 'Advanced', definition: 'რამდენიმე სენსორის ინფორმაციის გაერთიანება ერთ მოდელში.', learnMore: 'fusion perception-ის სიზუსტესა და robustness-ს ზრდის.' },
  { term: 'Open Vocabulary Detection', category: 'Computer Vision', level: 'Advanced', definition: 'ობიექტების პოვნა წინასწარ დახურული კლასების სიის გარეშე.', learnMore: 'ეს ხედვას ენობრივ წარმოდგენებთან აერთიანებს.' },
  { term: 'CLIP', category: 'Computer Vision', level: 'Advanced', definition: 'მოდელი, რომელიც ტექსტსა და სურათს საერთო სივრცეში აერთიანებს.', learnMore: 'CLIP multimodal retrieval-სა და zero-shot classification-ში გამოიყენება.' },
  { term: 'Contrastive Captioning', category: 'Computer Vision', level: 'Advanced', definition: 'მეთოდი, რომელიც სურათისა და ტექსტის შესაბამისობას contrastive სიგნალით აძლიერებს.', learnMore: 'იგი multimodal alignment-ს აუმჯობესებს.' },
  { term: 'Image Encoder', category: 'Computer Vision', level: 'Intermediate', definition: 'კომპონენტი, რომელიც სურათს ვექტორულ წარმოდგენად გარდაქმნის.', learnMore: 'იგი multimodal მოდელების ერთ-ერთი ძირითადი ნაწილი შეიძლება იყოს.' },
  { term: 'Text Encoder', category: 'NLP', level: 'Intermediate', definition: 'კომპონენტი, რომელიც ტექსტს embedding-ად გარდაქმნის.', learnMore: 'text encoder retrieval-სა და კლასიფიკაციაში ფართოდ გამოიყენება.' },
  { term: 'Decoder', category: 'Machine Learning', level: 'Beginner', definition: 'ქსელის ნაწილი, რომელიც წარმოდგენიდან გამოსავალს აგენერირებს ან აღადგენს.', learnMore: 'decoder გვხვდება seq2seq, autoencoder და diffusion სისტემებში.' },
  { term: 'Encoder', category: 'Machine Learning', level: 'Beginner', definition: 'ქსელის ნაწილი, რომელიც input-ს კომპაქტურ წარმოდგენად აქცევს.', learnMore: 'encoder-ები მნიშვნელოვანია classification-სა და retrieval-ში.' },
  { term: 'Encoder-Decoder', category: 'Machine Learning', level: 'Intermediate', definition: 'არქიტექტურა, სადაც ერთი ნაწილი კოდირებს, მეორე კი შედეგს წარმოქმნის.', learnMore: 'იგი თარგმანში, segmentation-ში და summarization-ში ხშირად გამოიყენება.' },
  { term: 'Masked Autoencoder (MAE)', category: 'Computer Vision', level: 'Advanced', definition: 'თვითზედამხედველობითი მოდელი, რომელიც სურათის დამალულ პატჩებს აღადგენს.', learnMore: 'MAE vision pretraining-ის ძლიერი მეთოდია.' },
  { term: 'DPO Dataset', category: 'Generative AI', level: 'Advanced', definition: 'წყვილოვანი preference მაგალითების ნაკრები DPO-სთვის.', learnMore: 'იგი არჩეულ და უარყოფილ პასუხებს შეიცავს.' },
  { term: 'SFT Dataset', category: 'Generative AI', level: 'Intermediate', definition: 'ინსტრუქცია-პასუხის მაგალითების ნაკრები supervised fine-tuning-ისთვის.', learnMore: 'კარგი SFT dataset ასისტენტის ქცევის ბაზას ქმნის.' },
  { term: 'Alignment Tax', category: 'Ethics & Safety', level: 'Advanced', definition: 'ხარისხის, თავისუფლების ან შესაძლებლობის შესაძლო შემცირება ძლიერი უსაფრთხოების სანაცვლოდ.', learnMore: 'ეს ტერმინი აღწერს trade-off-ს safety და capability შორის.' },
  { term: 'Misuse Prevention', category: 'Ethics & Safety', level: 'Intermediate', definition: 'ზიანის მომტანი გამოყენების თავიდან აცილების სტრატეგიები.', learnMore: 'მასში შედის მონიტორინგი, rate limit-ები და პოლიტიკის ფილტრები.' },
  { term: 'Safety Policy', category: 'Ethics & Safety', level: 'Beginner', definition: 'წესების ერთობლიობა, რომელიც განსაზღვრავს ნებადართულ და აკრძალულ ქცევას.', learnMore: 'სისტემა ამ პოლიტიკას prompt-სა და output-ზე მიმართავს.' },
  { term: 'Use Case Restriction', category: 'Ethics & Safety', level: 'Intermediate', definition: 'სისტემის გამოყენების შეზღუდვა მხოლოდ განსაზღვრულ სცენარებზე.', learnMore: 'ეს ამცირებს მაღალი რისკის გამოყენების ალბათობას.' },
  { term: 'Model Registry', category: 'Machine Learning', level: 'Intermediate', definition: 'ცენტრალური კატალოგი მოდელების ვერსიებისთვის და სტატუსისთვის.', learnMore: 'registry გუნდურ ML ოპერაციებს ამარტივებს.' },
  { term: 'Lineage Graph', category: 'Machine Learning', level: 'Advanced', definition: 'გრაფული წარმოდგენა მოდელის, მონაცემისა და პროცესების კავშირებზე.', learnMore: 'იგი აუდიტსა და debugging-ს ეხმარება.' },
  { term: 'Feature Importance', category: 'Machine Learning', level: 'Intermediate', definition: 'მახასიათებლის გავლენის ზომა მოდელის შედეგზე.', learnMore: 'feature importance explainability-ის ერთ-ერთი ძირითადი ტექნიკაა.' },
  { term: 'Permutation Importance', category: 'Machine Learning', level: 'Advanced', definition: 'importance შეფასება feature-ის შემთხვევითი შერევით.', learnMore: 'თუ ხარისხი ეცემა, feature მნიშვნელოვანი ყოფილა.' },
  { term: 'Partial Dependence Plot', category: 'Machine Learning', level: 'Advanced', definition: 'გრაფიკი, რომელიც ერთი feature-ის გავლენას აჩვენებს სხვა feature-ების გასაშუალოებით.', learnMore: 'იგი მოდელის ქცევის ინტერპრეტაციას ეხმარება.' },
  { term: 'Counterfactual Explanation', category: 'Ethics & Safety', level: 'Advanced', definition: 'განმარტება, რომელიც აჩვენებს რა მინიმალური ცვლილება შეცვლიდა შედეგს.', learnMore: 'ეს განსაკუთრებით სასარგებლოა გადაწყვეტილებების გასაგებად.' },
  { term: 'Calibration Set', category: 'Machine Learning', level: 'Intermediate', definition: 'ნაკრები, რომელიც confidence-ის კორექციისთვის გამოიყენება.', learnMore: 'იგი calibration მეთოდების დასარეგულირებლად არის საჭირო.' },
  { term: 'Platt Scaling', category: 'Machine Learning', level: 'Advanced', definition: 'კალიბრაციის მეთოდი, რომელიც logits-ს logistic ფუნქციით გარდაქმნის.', learnMore: 'ხშირად გამოიყენება binary classifier-ების probability calibration-ში.' },
  { term: 'Isotonic Regression', category: 'Machine Learning', level: 'Advanced', definition: 'არაპარამეტრული მონოტონური calibration მეთოდი.', learnMore: 'იგი მოქნილია, მაგრამ მეტი მონაცემი სჭირდება.' },
  { term: 'Temperature Scaling', category: 'Machine Learning', level: 'Advanced', definition: 'softmax logits-ის ერთ სკალარულ temperature-ზე დაყოფით კალიბრაცია.', learnMore: 'იგი თანამედროვე neural classifier-ებში გავრცელებულია.' },
  { term: 'Outlier', category: 'Machine Learning', level: 'Beginner', definition: 'მნიშვნელოვნად განსხვავებული დაკვირვება დანარჩენი მონაცემებისგან.', learnMore: 'outlier შეიძლება შეცდომაც იყოს ან რეალურად იშვიათი მოვლენა.' },
  { term: 'Data Profiling', category: 'Machine Learning', level: 'Intermediate', definition: 'მონაცემების სტატისტიკური და ხარისხობრივი ანალიზი მოდელირებამდე.', learnMore: 'profiling early-stage პრობლემებს ავლენს.' },
  { term: 'Schema Validation', category: 'Machine Learning', level: 'Intermediate', definition: 'მონაცემის სტრუქტურის შემოწმება განსაზღვრულ წესებთან შედარებით.', learnMore: 'ეს ingestion pipeline-ებში სანდოობას ზრდის.' },
  { term: 'Data Contract', category: 'Machine Learning', level: 'Intermediate', definition: 'შეთანხმებული წესები, როგორ ფორმატში და ხარისხით უნდა მოდიოდეს მონაცემი.', learnMore: 'data contract გუნდებს შორის პასუხისმგებლობას აზუსტებს.' },
  { term: 'Feature Drift Alert', category: 'Machine Learning', level: 'Intermediate', definition: 'სიგნალი, რომ რომელიმე feature მნიშვნელოვნად შეიცვალა.', learnMore: 'ასეთი alert რეაქტიულ მონიტორინგს ამარტივებს.' },
  { term: 'Concept Bottleneck Model', category: 'Machine Learning', level: 'Advanced', definition: 'მოდელი, რომელიც ჯერ ინტერპრეტირებად ცნებებს პროგნოზირებს და მერე საბოლოო პასუხს.', learnMore: 'ეს architecture explainability-ს აძლიერებს.' },
  { term: 'Neurosymbolic AI', category: 'Generative AI', level: 'Advanced', definition: 'ნეირონული და სიმბოლური reasoning-ის გაერთიანება.', learnMore: 'იგი სწავლასა და წესებზე დაფუძნებულ ლოგიკას აერთიანებს.' },
  { term: 'Symbolic Reasoning', category: 'Machine Learning', level: 'Advanced', definition: 'ლოგიკური წესებითა და სიმბოლოებით აზროვნება.', learnMore: 'სიმბოლური მიდგომები განმარტებადია, მაგრამ ნაკლებად მოქნილი.' },
  { term: 'Program Synthesis', category: 'Generative AI', level: 'Advanced', definition: 'სპეციფიკაციიდან ან მაგალითებიდან პროგრამის გენერაცია.', learnMore: 'კოდის გენერაციული მოდელები ამ მიმართულებას ამდიდრებს.' },
  { term: 'Code Completion', category: 'Generative AI', level: 'Beginner', definition: 'კოდის ავტომატური გაგრძელება პროგრამისტის წერისას.', learnMore: 'იგი პროდუქტიულობას ზრდის და ტემპს აჩქარებს.' },
  { term: 'Code Interpreter', category: 'Generative AI', level: 'Intermediate', definition: 'ინსტრუმენტი, რომელიც მოდელს კოდის გაშვების საშუალებას აძლევს.', learnMore: 'ასეთი საშუალება ანალიზსა და ციფრულ ამოცანებს აუმჯობესებს.' },
  { term: 'Execution Sandbox', category: 'Generative AI', level: 'Intermediate', definition: 'იზოლირებული გარემო მოდელის მიერ მოთხოვნილი კოდის უსაფრთხოდ გასაშვებად.', learnMore: 'sandbox უსაფრთხოებასა და კონტროლს უზრუნველყოფს.' },
  { term: 'Deterministic Output', category: 'Generative AI', level: 'Beginner', definition: 'შედეგი, რომელიც ერთნაირ input-ზე იგივეა.', learnMore: 'დეტერმინისტულობა დაბალი temperature-ით და constraints-ით იზრდება.' },
  { term: 'Non-Determinism', category: 'Generative AI', level: 'Intermediate', definition: 'იგივე მოთხოვნისას განსხვავებული პასუხების მიღების შესაძლებლობა.', learnMore: 'ეს ზოგჯერ სასარგებლოა კრეატიულობაში, მაგრამ ართულებს ტესტირებას.' },
  { term: 'Sampling Seed', category: 'Generative AI', level: 'Intermediate', definition: 'საწყისი მნიშვნელობა, რომელიც შემთხვევით გენერაციას მართავს.', learnMore: 'იგი reproducibility-ს აუმჯობესებს განსაკუთრებით გამოსახულებების გენერაციაში.' },
  { term: 'Latent Traversal', category: 'Generative AI', level: 'Advanced', definition: 'latent სივრცეში კონტროლირებადი გადაადგილება გენერაციის თვისებების სანახავად.', learnMore: 'ეს მოდელის შიდა წარმოდგენების კვლევაში გამოიყენება.' },
  { term: 'Prompt Token', category: 'Generative AI', level: 'Beginner', definition: 'ტოკენი, რომელიც მომხმარებლის მოთხოვნის ნაწილს წარმოადგენს.', learnMore: 'prompt token-ების რაოდენობა ფასსა და context-ს განსაზღვრავს.' },
  { term: 'Completion Token', category: 'Generative AI', level: 'Beginner', definition: 'ტოკენი, რომელიც მოდელმა პასუხის სახით დააგენერირა.', learnMore: 'completion token-ები პირდაპირ მოქმედებს ღირებულებაზე.' },
  { term: 'Reasoning Token', category: 'Generative AI', level: 'Advanced', definition: 'შიდა reasoning-ისთვის გამოყენებული დამატებითი ტოკენური რესურსი.', learnMore: 'ასეთი რესურსი რთულ ამოცანებზე პასუხის ხარისხს შეიძლება ზრდიდეს.' },
  { term: 'Latency Budget', category: 'Machine Learning', level: 'Intermediate', definition: 'მაქსიმალური დასაშვები დრო ერთი მოთხოვნისთვის.', learnMore: 'ბიუჯეტი სისტემის დიზაინისა და მოდელის არჩევას განსაზღვრავს.' },
  { term: 'Quality Gate', category: 'Machine Learning', level: 'Intermediate', definition: 'წესი ან ზღვარი, რომლის ქვემოთ მოდელი წარმოებაში არ გადის.', learnMore: 'quality gate დისციპლინირებულ გამოშვებებს უზრუნველყოფს.' },
  { term: 'Human Preference Eval', category: 'Generative AI', level: 'Intermediate', definition: 'ადამიანების შეფასებებით მოდელის პასუხების შედარება.', learnMore: 'ეს ავტომატურ მეტრიკებს ავსებს იქ, სადაც ხარისხი სუბიექტურია.' },
  { term: 'Pairwise Comparison', category: 'Generative AI', level: 'Intermediate', definition: 'ორი პასუხის პირდაპირი შედარება უპირატესობის გამოსავლენად.', learnMore: 'preference learning ხშირად pairwise მონაცემებით სწავლობს.' },
  { term: 'Rubric-Based Eval', category: 'Generative AI', level: 'Intermediate', definition: 'შეფასება წინასწარ განსაზღვრული კრიტერიუმებით.', learnMore: 'rubric შეფასებას უფრო სტრუქტურირებულსა და გამეორებადს ხდის.' },
  { term: 'Task Success Rate', category: 'Generative AI', level: 'Beginner', definition: 'რამდენად ხშირად ასრულებს სისტემა დავალებას წარმატებით.', learnMore: 'ეს პროდუქტის დონის მნიშვნელოვანი metric-ია.' },
  { term: 'User Satisfaction', category: 'Generative AI', level: 'Beginner', definition: 'მომხმარებლის შეფასებული კმაყოფილება AI სისტემის პასუხებით.', learnMore: 'საბოლოო პროდუქტის ხარისხი ხშირად სწორედ ამით იზომება.' },
  { term: 'Hallucination Audit', category: 'Generative AI', level: 'Intermediate', definition: 'პასუხების სისტემური გადამოწმება გამოგონილი ფაქტების გამოსავლენად.', learnMore: 'audit შეიძლება ადამიანურ ან ავტომატურ შემოწმებას აერთიანებდეს.' },
  { term: 'Fact Verification', category: 'Generative AI', level: 'Intermediate', definition: 'მოდელის მტკიცებების წყაროებთან ან ცოდნის ბაზასთან შემოწმება.', learnMore: 'verification განსაკუთრებით მნიშვნელოვანია საინფორმაციო ასისტენტებში.' },
  { term: 'Citation Grounding', category: 'Generative AI', level: 'Intermediate', definition: 'პასუხში ციტატებისა და წყაროების მიბმა რეალურ დოკუმენტებზე.', learnMore: 'ეს სანდოობას და შემოწმებადობას ზრდის.' },
  { term: 'Long-Term Memory', category: 'Generative AI', level: 'Intermediate', definition: 'შენახული ინფორმაცია, რომელიც აგენტს სესიებს შორის ახსოვს.', learnMore: 'იგი პერსონალიზაციასა და უწყვეტობას აძლიერებს.' },
  { term: 'Short-Term Memory', category: 'Generative AI', level: 'Beginner', definition: 'მიმდინარე სესიაში შენარჩუნებული აქტიური კონტექსტი.', learnMore: 'ეს ჩვეულებრივ prompt context-ში ან დროებით საცავში ინახება.' },
  { term: 'Session State', category: 'Generative AI', level: 'Intermediate', definition: 'მომხმარებელთან მიმდინარე ურთიერთობის დროებითი მდგომარეობა.', learnMore: 'session state მრავალსაფეხურიან UX-ს ამარტივებს.' },
  { term: 'Conversation Memory', category: 'Generative AI', level: 'Intermediate', definition: 'დიალოგიდან დაგროვილი კონტექსტი და მნიშვნელოვანი ფაქტები.', learnMore: 'იგი ასისტენტს უფრო თანმიმდევრულს ხდის.' },
  { term: 'Prompt Guard', category: 'Ethics & Safety', level: 'Intermediate', definition: 'სისტემა, რომელიც prompt-ს ამოწმებს რისკიან შინაარსზე.', learnMore: 'იგი prompt injection-სა და misuse-ს ამცირებს.' },
  { term: 'Output Guard', category: 'Ethics & Safety', level: 'Intermediate', definition: 'სისტემა, რომელიც საბოლოო პასუხს ფილტრავს ან ასწორებს.', learnMore: 'output guard ბოლო უსაფრთხოების ფენას წარმოადგენს.' },
  { term: 'Safety Classifier', category: 'Ethics & Safety', level: 'Intermediate', definition: 'კლასიფიკატორი, რომელიც რისკიან ან პოლიტიკის დამრღვევ შინაარსს ამოიცნობს.', learnMore: 'იგი moderation pipeline-ის ნაწილია.' },
  { term: 'Policy Violation', category: 'Ethics & Safety', level: 'Beginner', definition: 'პასუხი ან ქმედება, რომელიც განსაზღვრულ წესს არღვევს.', learnMore: 'სისტემამ ასეთი შემთხვევა უნდა დაბლოკოს ან გადაამოწმოს.' },
  { term: 'Red Team Prompt Set', category: 'Ethics & Safety', level: 'Advanced', definition: 'საფრთხის შემცველი მოთხოვნების ნაკრები უსაფრთხოების ტესტირებისთვის.', learnMore: 'იგი სისტემური სისუსტეების გამოვლენაში გამოიყენება.' },
  { term: 'Abuse Monitoring', category: 'Ethics & Safety', level: 'Intermediate', definition: 'სერვისის არასათანადო გამოყენების დაკვირვება და ანალიზი.', learnMore: 'monitoring დროულ რეაგირებას შესაძლებელს ხდის.' },
  { term: 'Incident Response', category: 'Ethics & Safety', level: 'Intermediate', definition: 'ინციდენტის აღმოჩენის შემდეგ რეაგირების პროცესი.', learnMore: 'იგი მოიცავს triage-ს, mitigation-ს და კომუნიკაციას.' },
  { term: 'Fallback Model', category: 'Machine Learning', level: 'Intermediate', definition: 'სარეზერვო მოდელი, რომელიც ძირითადის პრობლემისას აქტიურდება.', learnMore: 'fallback მდგრადობას ზრდის.' },
  { term: 'Heuristic Baseline', category: 'Machine Learning', level: 'Beginner', definition: 'მარტივი წესებზე დაფუძნებული baseline სისტემის შესადარებლად.', learnMore: 'ხშირად იგი გვიჩვენებს რამდენად ამართლებს რთული მოდელი თავის ფასს.' },
  { term: 'Oracle Model', category: 'Machine Learning', level: 'Advanced', definition: 'იდეალიზებული ან ზედა ზღვრის მაჩვენებელი მოდელი შედარებისთვის.', learnMore: 'oracle რეალურ deployment-ში არ არის ხელმისაწვდომი, მაგრამ ceiling-ს აჩვენებს.' },
  { term: 'Error Analysis', category: 'Machine Learning', level: 'Beginner', definition: 'შეცდომების ხელით ან ავტომატურად კვლევა გამომწვევი მიზეზების დასადგენად.', learnMore: 'error analysis მოდელის გაუმჯობესების ერთ-ერთი საუკეთესო გზაა.' },
  { term: 'Failure Mode', category: 'Machine Learning', level: 'Intermediate', definition: 'დამახასიათებელი გზა, რომლითაც მოდელი ცდება ან მარცხდება.', learnMore: 'failure mode-ების ცოდნა risk mitigation-ს ამარტივებს.' },
  { term: 'Calibration Drift', category: 'Machine Learning', level: 'Advanced', definition: 'დროთა განმავლობაში confidence-ის სანდოობის ცვლილება.', learnMore: 'ეს განსაკუთრებით მნიშვნელოვანია რისკიან გადაწყვეტილებებში.' },
  { term: 'Serving Timeout', category: 'Machine Learning', level: 'Beginner', definition: 'დროის ლიმიტი, რომლის გადაცილებისას მოთხოვნა წყდება.', learnMore: 'timeouts იცავს სისტემას ჩამოკიდებული მოთხოვნებისგან.' },
  { term: 'Inference Queue', category: 'Machine Learning', level: 'Intermediate', definition: 'რიგი, რომელშიც მოსული მოთხოვნები მოდელის დამუშავებას ელოდება.', learnMore: 'queue throughput-სა და fairness-ს მართავს.' },
  { term: 'Backpressure', category: 'Machine Learning', level: 'Advanced', definition: 'დატვირთვის შეკავების მექანიზმი, როცა სისტემა გადატვირთვას უახლოვდება.', learnMore: 'backpressure სტაბილურობას ინარჩუნებს მაღალი ტრაფიკის დროს.' },
  { term: 'Token Throughput', category: 'Generative AI', level: 'Intermediate', definition: 'ერთეულ დროში გენერირებული ან დამუშავებული ტოკენების რაოდენობა.', learnMore: 'ეს LLM serving-ის ძირითადი performance metric-ია.' },
  { term: 'Prefill Phase', category: 'Generative AI', level: 'Advanced', definition: 'ინფერენსის ნაწილი, სადაც მოდელი prompt-ის ყველა ტოკენს ამუშავებს.', learnMore: 'prefill განსაკუთრებით ძვირია გრძელი prompt-ებისას.' },
  { term: 'Decode Phase', category: 'Generative AI', level: 'Advanced', definition: 'გენერაციის ნაწილი, სადაც პასუხის ტოკენები ერთიმეორის მიყოლებით იწარმოება.', learnMore: 'KV cache decode phase-ს აჩქარებს.' },
  { term: 'Context Length', category: 'Generative AI', level: 'Beginner', definition: 'prompt-ში მოთავსებული აქტიური ტოკენების სიგრძე.', learnMore: 'დიდი context უფრო მეტ მეხსიერებასა და ფასს მოითხოვს.' },
  { term: 'Hallucination Mitigation', category: 'Generative AI', level: 'Intermediate', definition: 'მეთოდები, რომლებიც გამოგონილი პასუხების რაოდენობას ამცირებს.', learnMore: 'ამაში შედის RAG, verification და constraints.' },
...
const CATEGORY_LABELS = {
  ...
  'Computer Vision': 'კომპიუტერული ხედვა',
...
const categories = ['ყველა', ...new Set(terms.map((item) => item.category))];
...
function updateProgress(totalVisible = terms.length) {
  progressTracker.textContent = `${exploredTerms.size} / ${totalVisible} ტერმინი ნანახია`; 
}
    ...
    <div class="card-inner">
      <div class="card-face card-front">
        <div class="term-head">
          ...
          <span class="badge ${levelClass(item.level)}">${LEVEL_LABELS[item.level] || item.level}</span>
        </div>
        <p class="category">${CATEGORY_LABELS[item.category] || item.category}</p>
        <p class="quiz-hint">დააჭირეთ მნიშვნელობის სანახავად</p>
      </div>
      <div class="card-face card-back">
        ...
        <button class="learn-btn" type="button">გაიგეთ მეტი</button>
        <p class="learn-more"><strong>დამატებით:</strong> ${item.learnMore}</p>
      </div>
    </div>
  `;
...
function renderCategories() {
  ...
  categories.forEach((category) => {
    ...
    btn.textContent = category === 'ყველა' ? 'ყველა' : CATEGORY_LABELS[category] || category;
...
function getFilteredTerms() {
  ...
  return terms.filter((item) => {
    const inCategory = activeCategory === 'ყველა' || item.category === activeCategory;
    const inSearch =
      item.term.toLowerCase().includes(query) ||
      item.definition.toLowerCase().includes(query) ||
      item.category.toLowerCase().includes(query) ||
      (CATEGORY_LABELS[item.category] || '').toLowerCase().includes(query) ||
      (LEVEL_LABELS[item.level] || '').toLowerCase().includes(query);
...
function setTheme(mode) {
  ...
  themeLabel.textContent = mode === 'dark' ? '☀️ ნათელი' : '🌙 მუქი';
}
